 ...
 *
 */
open class UsbPortDevice(context: Context,aioDeviceType:Int, val port: UsbSerialPort? = null,val parameter: UsbMeasureParameter, parser: Parser, listener: ReceiveResultListener)
